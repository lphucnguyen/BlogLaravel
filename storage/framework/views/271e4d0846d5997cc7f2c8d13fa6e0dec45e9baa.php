            ...
            <div class="leftSide">
                ...
                <article class="article">
                    <div class="articleInfo">
                        <a href="<?php echo e(route('category', $post->category->categoryName)); ?>" class="articleCategory"><i class="fa fa-folder-open-o"></i><?php echo e($post->category->categoryName); ?></a>
                    </div>
...
<?php echo $__env->make('layouts.frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog-laravel\resources\views\frontend\tag.blade.php ENDPATH**/ ?>