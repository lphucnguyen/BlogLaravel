<div class="leftSide">
    ...
    <article class="article">
        ...
        <div class="articleSocials">
            ...
            <a target="_blank" href="https://twitter.com/intent/tweet?text=YOUR-TEXT&url=<?php echo e(urlencode(route('post', $post->slug))); ?>&via=TWITTER-HANDLER" class="articleSocial twitter"><i class="fa fa-twitter"></i></a>
            <a target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo e(urlencode(route('post', $post->slug))); ?>&description=YOUR-DESCRIPTION" class="articleSocial pinterest"><i class="fa fa-pinterest"></i></a>
            <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(urlencode(route('post', $post->slug))); ?>&title=YOUR-TITLE&source=YOUR-URL" class="articleSocial linkedin"><i class="fa fa-linkedin"></i></a>
        </div>
    </article>
