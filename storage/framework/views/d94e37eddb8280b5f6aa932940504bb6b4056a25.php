...
<?php $__env->startSection('title', $tag->tagName); ?>
...
<main>
    <section id="content">
        <div class="container mainContent">
            <div class="leftSide">
                <p class="showTitle">Show post with tag "<?php echo e($tag->tagName); ?>"</p> 
                ...
                <article class="article">
                    ...
                    <div class="articleSocials">
                        ...
                        <a target="_blank" href="https://twitter.com/intent/tweet?text=<?php echo e(urlencode($post->title)); ?>&url=<?php echo e(urlencode(route('post', [$post->slug, $post->id]))); ?>&via=TWITTER-HANDLER" class="articleSocial twitter"><i class="fa fa-twitter"></i></a>
                        <a target="_blank" href="http://pinterest.com/pin/create/button/?url=<?php echo e(urlencode(route('post', [$post->slug, $post->id]))); ?>&description=<?php echo e(urlencode($post->title)); ?>" class="articleSocial pinterest"><i class="fa fa-pinterest"></i></a>
                        <a target="_blank" href="http://www.linkedin.com/shareArticle?mini=true&url=<?php echo e(urlencode(route('post', [$post->slug, $post->id]))); ?>&title=<?php echo e(urlencode($post->title)); ?>&source=YOUR-URL" class="articleSocial linkedin"><i class="fa fa-linkedin"></i></a>
                    </div>
                </article>
...
<?php echo $__env->make('layouts.frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\blog-laravel\resources\views/frontend/tag.blade.php ENDPATH**/ ?>