<div class="rightSide">
    ...
    <div class="categoryContain">
        ...
        <ul class="categoryMenu">
            ...
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <li><a href="<?php echo e(route('category', $category->slug)); ?>"><?php echo e($category->categoryName); ?></a></li>
    ...
    <div class="popularPost">
        ...
        <div class="post">
            ...
            <a href="<?php echo e(route('post', $postPopular->slug)); ?>" class="titlePost"><?php echo e($postPopular->title); ?></a>
        </div>                        
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
